...
class FoundItemPageScreen extends StatefulWidget {
  const FoundItemPageScreen({super.key});

  @override
  State<FoundItemPageScreen> createState() => _FoundItemPageScreenState();
}

class _FoundItemPageScreenState extends State<FoundItemPageScreen> {
  ...
  Future<String> uploadImageToStorage() async {
    try {
      ...
      firebase_storage.Reference storageReference = firebase_storage
          ...
          .ref()
          .child('foundStoreImages/${DateTime.now().millisecondsSinceEpoch}');
